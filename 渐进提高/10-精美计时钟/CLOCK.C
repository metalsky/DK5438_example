...
__no_init int HOUR_HAND_BUF[400][2]                       ; // 分针图形缓冲
__no_init int HOUR_HAND_BK_BUF[400]                       ; // 分针背景缓冲
__no_init int MINU_HAND_BUF[600][2]                       ; // 分针图形缓冲
__no_init int MINU_HAND_BK_BUF[600]                       ; // 分针背景缓冲
__no_init int SEC_HAND_BUF[100][2]                        ; // 秒针图形缓冲
__no_init int SEC_HAND_BK_BUF[100]                        ; // 秒针背景缓冲

int minu_comp = 0                                         ; // 分针补偿计数器
int hour_comp = 0                                         ; // 时针补偿计数器
