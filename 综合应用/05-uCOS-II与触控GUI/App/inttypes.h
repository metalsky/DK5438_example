...
__ATTRIBUTES intmax_t imaxabs(intmax_t);
__ATTRIBUTES imaxdiv_t imaxdiv(intmax_t, intmax_t);

__ATTRIBUTES intmax_t strtoimax(const char *, char **, int);
__ATTRIBUTES uintmax_t strtoumax(const char *, char **, int);
__ATTRIBUTES intmax_t wcstoimax(const _Wchart *, _Wchart **, int);
__ATTRIBUTES uintmax_t wcstoumax(const _Wchart *, _Wchart **, int);
_END_C_LIB_DECL
