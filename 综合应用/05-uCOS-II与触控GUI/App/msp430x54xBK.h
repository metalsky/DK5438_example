...
#else
#define __ACCESS_20BIT_REG__  volatile unsigned long
#endif
...
#define PMMREFACC           (0x0002)  /* PMM Reference Accuracy */
...
#define PMMREFACC_L         (0x0002)  /* PMM Reference Accuracy */
...
/* SVSMIO Control Bits */
#define SVSLEVE             (0x0001)  /* SVS low side external voltage input enable */
#define SVMLEVE             (0x0002)  /* SVM low side external voltage input enable */
#define SVMLOE              (0x0008)  /* SVM low side output enable */
#define SVMLVRLOE           (0x0010)  /* SVM low side voltage level reached output enable */
#define SVMOUTPOL           (0x0020)  /* SVMOUT pin polarity */
#define SVSHEVE             (0x0100)  /* SVS high side external voltage input enable */
#define SVMHEVE             (0x0200)  /* SVM high side external voltage input enable */
#define SVMHOE              (0x0800)  /* SVM high side output enable */
#define SVMHVRLOE           (0x1000)  /* SVM high side voltage level reached output enable */

/* SVSMIO Control Bits */
#define SVSLEVE_L           (0x0001)  /* SVS low side external voltage input enable */
#define SVMLEVE_L           (0x0002)  /* SVM low side external voltage input enable */
#define SVMLOE_L            (0x0008)  /* SVM low side output enable */
#define SVMLVRLOE_L         (0x0010)  /* SVM low side voltage level reached output enable */
#define SVMOUTPOL_L         (0x0020)  /* SVMOUT pin polarity */

/* SVSMIO Control Bits */
#define SVSHEVE_H           (0x0001)  /* SVS high side external voltage input enable */
#define SVMHEVE_H           (0x0002)  /* SVM high side external voltage input enable */
#define SVMHOE_H            (0x0008)  /* SVM high side output enable */
#define SVMHVRLOE_H         (0x0010)  /* SVM high side voltage level reached output enable */
...
#define RTCCTL01_           (0x0480)  /* Real Timer Control 0/1 */
DEFCW(  RTCCTL01          , RTCCTL01_)
#define RTCCTL23_           (0x0482)  /* Real Timer Control 2/3 */
DEFCW(  RTCCTL23          , RTCCTL23_)
#define RTCPS0CTL_          (0x0488)  /* Real Timer Prescale Timer 0 Control */
DEFCW(  RTCPS0CTL         , RTCPS0CTL_)
#define RTCPS1CTL_          (0x048A)  /* Real Timer Prescale Timer 1 Control */
DEFCW(  RTCPS1CTL         , RTCPS1CTL_)
#define RTCPS_              (0x048C)  /* Real Timer Prescale Timer Control */
DEFCW(  RTCPS             , RTCPS_)
#define RTCIV_              (0x048E)  /* Real Time Clock Interrupt Vector */
DEFW(   RTCIV             , RTCIV_)
#define RTCTIM0_            (0x0490)  /* Real Time Clock Time 0 */
DEFCW(  RTCTIM0           , RTCTIM0_)
#define RTCTIM1_            (0x0492)  /* Real Time Clock Time 1 */
DEFCW(  RTCTIM1           , RTCTIM1_)
#define RTCDATE_            (0x0494)  /* Real Time Clock Date */
DEFCW(  RTCDATE           , RTCDATE_)
#define RTCYEAR_            (0x0496)  /* Real Time Clock Year */
DEFCW(  RTCYEAR           , RTCYEAR_)
#define RTCAMINHR_          (0x0498)  /* Real Time Clock Alarm Min/Hour */
DEFCW(  RTCAMINHR         , RTCAMINHR_)
#define RTCADOWDAY_         (0x049A)  /* Real Time Clock Alarm day of week/day */
...
#define  SYSARB_             (0x0184)  /* JTAG Arbitration configuration */
DEFCW(   SYSARB            , SYSARB_)
...
#define SYSRSTIV_PORTWU2   (0x000A)    /* SYSRSTIV : Port Wake Up */
#define SYSRSTIV_SECYV     (0x000C)    /* SYSRSTIV : Security violation */
...
#define  TA0CTL_             (0x0340)  /* Timer1_A5 Control */
DEFCW(   TA0CTL            , TA0CTL_)
#define  TA0CCTL0_           (0x0342)  /* Timer1_A5 Capture/Compare Control 0 */
DEFCW(   TA0CCTL0          , TA0CCTL0_)
#define  TA0CCTL1_           (0x0344)  /* Timer1_A5 Capture/Compare Control 1 */
DEFCW(   TA0CCTL1          , TA0CCTL1_)
#define  TA0CCTL2_           (0x0346)  /* Timer1_A5 Capture/Compare Control 2 */
DEFCW(   TA0CCTL2          , TA0CCTL2_)
#define  TA0CCTL3_           (0x0348)  /* Timer1_A5 Capture/Compare Control 3 */
DEFCW(   TA0CCTL3          , TA0CCTL3_)
#define  TA0CCTL4_           (0x034A)  /* Timer1_A5 Capture/Compare Control 4 */
DEFCW(   TA0CCTL4          , TA0CCTL4_)
#define  TA0R_               (0x0350)  /* Timer1_A5 */
DEFCW(   TA0R              , TA0R_)
#define  TA0CCR0_            (0x0352)  /* Timer1_A5 Capture/Compare 0 */
DEFCW(   TA0CCR0           , TA0CCR0_)
#define  TA0CCR1_            (0x0354)  /* Timer1_A5 Capture/Compare 1 */
DEFCW(   TA0CCR1           , TA0CCR1_)
#define  TA0CCR2_            (0x0356)  /* Timer1_A5 Capture/Compare 2 */
DEFCW(   TA0CCR2           , TA0CCR2_)
#define  TA0CCR3_            (0x0358)  /* Timer1_A5 Capture/Compare 3 */
DEFCW(   TA0CCR3           , TA0CCR3_)
#define  TA0CCR4_            (0x035A)  /* Timer1_A5 Capture/Compare 4 */
DEFCW(   TA0CCR4           , TA0CCR4_)
#define TA0IV_              (0x036E)  /* Timer1_A5 Interrupt Vector Word */
READ_ONLY_DEFCW( TA0IV          , TA0IV_)
#define  TA0EX0_             (0x0360)  /* Timer0_A3 Expansion Register 0 */
DEFCW(   TA0EX0            , TA0EX0_)
...
#define  TA1CTL_             (0x0380)  /* Timer0_A3 Control */
DEFCW(   TA1CTL            , TA1CTL_)
#define  TA1CCTL0_           (0x0382)  /* Timer0_A3 Capture/Compare Control 0 */
DEFCW(   TA1CCTL0          , TA1CCTL0_)
#define  TA1CCTL1_           (0x0384)  /* Timer0_A3 Capture/Compare Control 1 */
DEFCW(   TA1CCTL1          , TA1CCTL1_)
#define  TA1CCTL2_           (0x0386)  /* Timer0_A3 Capture/Compare Control 2 */
DEFCW(   TA1CCTL2          , TA1CCTL2_)
#define  TA1R_               (0x0390)  /* Timer0_A3 */
DEFCW(   TA1R              , TA1R_)
#define  TA1CCR0_            (0x0392)  /* Timer0_A3 Capture/Compare 0 */
DEFCW(   TA1CCR0           , TA1CCR0_)
#define  TA1CCR1_            (0x0394)  /* Timer0_A3 Capture/Compare 1 */
DEFCW(   TA1CCR1           , TA1CCR1_)
#define  TA1CCR2_            (0x0396)  /* Timer0_A3 Capture/Compare 2 */
DEFCW(   TA1CCR2           , TA1CCR2_)
#define TA1IV_              (0x03AE)  /* Timer0_A3 Interrupt Vector Word */
READ_ONLY_DEFCW( TA1IV          , TA1IV_)
#define  TA1EX0_             (0x03A0)  /* Timer0_A3 Expansion Register 0 */
DEFCW(   TA1EX0            , TA1EX0_)
...
#define  TBCTL_              (0x03C0)  /* Timer B Control */
DEFCW(   TBCTL             , TBCTL_)
#define  TBCCTL0_            (0x03C2)  /* Timer B Capture/Compare Control 0 */
DEFCW(   TBCCTL0           , TBCCTL0_)
#define  TBCCTL1_            (0x03C4)  /* Timer B Capture/Compare Control 1 */
DEFCW(   TBCCTL1           , TBCCTL1_)
#define  TBCCTL2_            (0x03C6)  /* Timer B Capture/Compare Control 2 */
DEFCW(   TBCCTL2           , TBCCTL2_)
#define  TBCCTL3_            (0x03C8)  /* Timer B Capture/Compare Control 3 */
DEFCW(   TBCCTL3           , TBCCTL3_)
#define  TBCCTL4_            (0x03CA)  /* Timer B Capture/Compare Control 4 */
DEFCW(   TBCCTL4           , TBCCTL4_)
#define  TBCCTL5_            (0x03CC)  /* Timer B Capture/Compare Control 5 */
DEFCW(   TBCCTL5           , TBCCTL5_)
#define  TBCCTL6_            (0x03CE)  /* Timer B Capture/Compare Control 6 */
DEFCW(   TBCCTL6           , TBCCTL6_)
#define  TBR_                (0x03D0)  /* Timer B */
DEFCW(   TBR               , TBR_)
#define  TBCCR0_             (0x03D2)  /* Timer B Capture/Compare 0 */
DEFCW(   TBCCR0            , TBCCR0_)
#define  TBCCR1_             (0x03D4)  /* Timer B Capture/Compare 1 */
DEFCW(   TBCCR1            , TBCCR1_)
#define  TBCCR2_             (0x03D6)  /* Timer B Capture/Compare 2 */
DEFCW(   TBCCR2            , TBCCR2_)
#define  TBCCR3_             (0x03D8)  /* Timer B Capture/Compare 3 */
DEFCW(   TBCCR3            , TBCCR3_)
#define  TBCCR4_             (0x03DA)  /* Timer B Capture/Compare 4 */
DEFCW(   TBCCR4            , TBCCR4_)
#define  TBCCR5_             (0x03DC)  /* Timer B Capture/Compare 5 */
DEFCW(   TBCCR5            , TBCCR5_)
#define  TBCCR6_             (0x03DE)  /* Timer B Capture/Compare 6 */
DEFCW(   TBCCR6            , TBCCR6_)
#define  TBEX0_              (0x03E0)  /* Timer B Expansion Register 0 */
DEFCW(   TBEX0             , TBEX0_)
#define TBIV_               (0x03EE)  /* Timer B Interrupt Vector Word */
READ_ONLY_DEFCW( TBIV           , TBIV_)
...
/* TBCTL Control Bits */
#define TBCLR_L             (0x0004)  /* Timer B counter clear */
#define TBIE_L              (0x0002)  /* Timer B interrupt enable */
#define TBIFG_L             (0x0001)  /* Timer B interrupt flag */

/* TBCTL Control Bits */
#define TBCLGRP1_H          (0x0040)  /* Timer B Compare latch load group 1 */
#define TBCLGRP0_H          (0x0020)  /* Timer B Compare latch load group 0 */
...
#define TBSSEL__TACLK       (0*0x100u) /* Timer A clock source select: 0 - TACLK */
#define TBSSEL__ACLK        (1*0x100u) /* Timer A clock source select: 1 - ACLK  */
#define TBSSEL__SMCLK       (2*0x100u) /* Timer A clock source select: 2 - SMCLK */
#define TBSSEL__INCLK       (3*0x100u) /* Timer A clock source select: 3 - INCLK */
...
/* TBEX0 Control Bits */
#define TBIDEX0             (0x0001)   /* Timer B Input divider expansion Bit: 0 */
#define TBIDEX1             (0x0002)   /* Timer B Input divider expansion Bit: 1 */
#define TBIDEX2             (0x0004)   /* Timer B Input divider expansion Bit: 2 */

/* TBEX0 Control Bits */
#define TBIDEX0_L           (0x0001)   /* Timer B Input divider expansion Bit: 0 */
#define TBIDEX1_L           (0x0002)   /* Timer B Input divider expansion Bit: 1 */
#define TBIDEX2_L           (0x0004)   /* Timer B Input divider expansion Bit: 2 */
...
#define FLLULIE             (0x0100)    /* FLL Unlock Interrupt Enable */
#define FLLWARNEN           (0x0200)    /* FLL Warning Enable */
//#define RESERVED            (0x4000)    /* RESERVED */
//#define RESERVED            (0x8000)    /* RESERVED */
...
#define FLLULIE_H           (0x0001)    /* FLL Unlock Interrupt Enable */
#define FLLWARNEN_H         (0x0002)    /* FLL Warning Enable */
//#define RESERVED            (0x4000)    /* RESERVED */
//#define RESERVED            (0x8000)    /* RESERVED */
...
#define UCA0CTL0_           (0x05C1)  /* USCI A0 Control Register 0 */
DEFC(   UCA0CTL0          , UCA0CTL0_)
#define UCA0CTL1_           (0x05C0)  /* USCI A0 Control Register 1 */
DEFC(   UCA0CTL1          , UCA0CTL1_)
#define UCA0BR0_            (0x05C6)  /* USCI A0 Baud Rate 0 */
DEFC(   UCA0BR0           , UCA0BR0_)
#define UCA0BR1_            (0x05C7)  /* USCI A0 Baud Rate 1 */
...
#define UCA0IRTCTL_         (0x05D2)  /* USCI A0 IrDA Transmit Control */
DEFC(   UCA0IRTCTL        , UCA0IRTCTL_)
#define UCA0IRRCTL_         (0x05D3)  /* USCI A0 IrDA Receive Control */
DEFC(   UCA0IRRCTL        , UCA0IRRCTL_)
#define UCA0IE_             (0x05DC)  /* USCI A0 Interrupt Enable Register */
DEFC(   UCA0IE            , UCA0IE_)
#define UCA0IFG_            (0x05DD)  /* USCI A0 Interrupt Flags Register */
DEFC(   UCA0IFG           , UCA0IFG_)
#define UCA0IV_             (0x05DE)  /* USCI A0 Interrupt Vector Register */
DEFW(   UCA0IV            , UCA0IV_)



#define UCB0CTL0_           (0x05E1)  /* USCI B0 Control Register 0 */
DEFC(   UCB0CTL0          , UCB0CTL0_)
#define UCB0CTL1_           (0x05E0)  /* USCI B0 Control Register 1 */
DEFC(   UCB0CTL1          , UCB0CTL1_)
#define UCB0BR0_            (0x05E6)  /* USCI B0 Baud Rate 0 */
DEFC(   UCB0BR0           , UCB0BR0_)
#define UCB0BR1_            (0x05E7)  /* USCI B0 Baud Rate 1 */
...
#define UCB0IE_             (0x05FC)  /* USCI B0 Interrupt Enable Register */
DEFC(   UCB0IE            , UCB0IE_)
#define UCB0IFG_            (0x05FD)  /* USCI B0 Interrupt Flags Register */
DEFC(   UCB0IFG           , UCB0IFG_)
#define UCB0IV_             (0x05FE)  /* USCI B0 Interrupt Vector Register */
DEFW(   UCB0IV            , UCB0IV_)

#define UCA1CTL0_           (0x0601)  /* USCI A1 Control Register 0 */
DEFC(   UCA1CTL0          , UCA1CTL0_)
#define UCA1CTL1_           (0x0600)  /* USCI A1 Control Register 1 */
DEFC(   UCA1CTL1          , UCA1CTL1_)
#define UCA1BR0_            (0x0606)  /* USCI A1 Baud Rate 0 */
DEFC(   UCA1BR0           , UCA1BR0_)
#define UCA1BR1_            (0x0607)  /* USCI A1 Baud Rate 1 */
...
#define UCA1IRTCTL_         (0x0612)  /* USCI A1 IrDA Transmit Control */
DEFC(   UCA1IRTCTL        , UCA1IRTCTL_)
#define UCA1IRRCTL_         (0x0613)  /* USCI A1 IrDA Receive Control */
DEFC(   UCA1IRRCTL        , UCA1IRRCTL_)
#define UCA1IE_             (0x061C)  /* USCI A1 Interrupt Enable Register */
DEFC(   UCA1IE            , UCA1IE_)
#define UCA1IFG_            (0x061D)  /* USCI A1 Interrupt Flags Register */
DEFC(   UCA1IFG           , UCA1IFG_)
#define UCA1IV_             (0x061E)  /* USCI A1 Interrupt Vector Register */
DEFW(   UCA1IV            , UCA1IV_)



#define UCB1CTL0_           (0x0621)  /* USCI B1 Control Register 0 */
DEFC(   UCB1CTL0          , UCB1CTL0_)
#define UCB1CTL1_           (0x0620)  /* USCI B1 Control Register 1 */
DEFC(   UCB1CTL1          , UCB1CTL1_)
#define UCB1BR0_            (0x0626)  /* USCI B1 Baud Rate 0 */
DEFC(   UCB1BR0           , UCB1BR0_)
#define UCB1BR1_            (0x0627)  /* USCI B1 Baud Rate 1 */
...
#define UCB1IE_             (0x063C)  /* USCI B1 Interrupt Enable Register */
DEFC(   UCB1IE            , UCB1IE_)
#define UCB1IFG_            (0x063D)  /* USCI B1 Interrupt Flags Register */
DEFC(   UCB1IFG           , UCB1IFG_)
#define UCB1IV_             (0x063E)  /* USCI B1 Interrupt Vector Register */
DEFW(   UCB1IV            , UCB1IV_)

#define UCA2CTL0_           (0x0641)  /* USCI A2 Control Register 0 */
DEFC(   UCA2CTL0          , UCA2CTL0_)
#define UCA2CTL1_           (0x0640)  /* USCI A2 Control Register 1 */
DEFC(   UCA2CTL1          , UCA2CTL1_)
#define UCA2BR0_            (0x0646)  /* USCI A2 Baud Rate 0 */
DEFC(   UCA2BR0           , UCA2BR0_)
#define UCA2BR1_            (0x0647)  /* USCI A2 Baud Rate 1 */
DEFC(   UCA2BR1           , UCA2BR1_)
...
#define UCA2IRTCTL_         (0x0652)  /* USCI A2 IrDA Transmit Control */
DEFC(   UCA2IRTCTL        , UCA2IRTCTL_)
#define UCA2IRRCTL_         (0x0653)  /* USCI A2 IrDA Receive Control */
DEFC(   UCA2IRRCTL        , UCA2IRRCTL_)
#define UCA2IE_             (0x065C)  /* USCI A2 Interrupt Enable Register */
DEFC(   UCA2IE            , UCA2IE_)
#define UCA2IFG_            (0x065D)  /* USCI A2 Interrupt Flags Register */
DEFC(   UCA2IFG           , UCA2IFG_)
#define UCA2IV_             (0x065E)  /* USCI A2 Interrupt Vector Register */
DEFW(   UCA2IV            , UCA2IV_)



#define UCB2CTL0_           (0x0661)  /* USCI B2 Control Register 0 */
DEFC(   UCB2CTL0          , UCB2CTL0_)
#define UCB2CTL1_           (0x0660)  /* USCI B2 Control Register 1 */
DEFC(   UCB2CTL1          , UCB2CTL1_)
#define UCB2BR0_            (0x0666)  /* USCI B2 Baud Rate 0 */
DEFC(   UCB2BR0           , UCB2BR0_)
#define UCB2BR1_            (0x0667)  /* USCI B2 Baud Rate 1 */
DEFC(   UCB2BR1           , UCB2BR1_)
...
#define UCB2IE_             (0x067C)  /* USCI B2 Interrupt Enable Register */
DEFC(   UCB2IE            , UCB2IE_)
#define UCB2IFG_            (0x067D)  /* USCI B2 Interrupt Flags Register */
DEFC(   UCB2IFG           , UCB2IFG_)
#define UCB2IV_             (0x067E)  /* USCI B2 Interrupt Vector Register */
DEFW(   UCB2IV            , UCB2IV_)

#define UCA3CTL0_           (0x0681)  /* USCI A3 Control Register 0 */
DEFC(   UCA3CTL0          , UCA3CTL0_)
#define UCA3CTL1_           (0x0680)  /* USCI A3 Control Register 1 */
DEFC(   UCA3CTL1          , UCA3CTL1_)
#define UCA3BR0_            (0x0686)  /* USCI A3 Baud Rate 0 */
DEFC(   UCA3BR0           , UCA3BR0_)
#define UCA3BR1_            (0x0687)  /* USCI A3 Baud Rate 1 */
DEFC(   UCA3BR1           , UCA3BR1_)
...
#define UCA3IRTCTL_         (0x0692)  /* USCI A3 IrDA Transmit Control */
DEFC(   UCA3IRTCTL        , UCA3IRTCTL_)
#define UCA3IRRCTL_         (0x0693)  /* USCI A3 IrDA Receive Control */
DEFC(   UCA3IRRCTL        , UCA3IRRCTL_)
#define UCA3IE_             (0x069C)  /* USCI A3 Interrupt Enable Register */
DEFC(   UCA3IE            , UCA3IE_)
#define UCA3IFG_            (0x069D)  /* USCI A3 Interrupt Flags Register */
DEFC(   UCA3IFG           , UCA3IFG_)
#define UCA3IV_             (0x069E)  /* USCI A3 Interrupt Vector Register */
DEFW(   UCA3IV            , UCA3IV_)



#define UCB3CTL0_           (0x06A1)  /* USCI B3 Control Register 0 */
DEFC(   UCB3CTL0          , UCB3CTL0_)
#define UCB3CTL1_           (0x06A0)  /* USCI B3 Control Register 1 */
DEFC(   UCB3CTL1          , UCB3CTL1_)
#define UCB3BR0_            (0x06A6)  /* USCI B3 Baud Rate 0 */
DEFC(   UCB3BR0           , UCB3BR0_)
#define UCB3BR1_            (0x06A7)  /* USCI B3 Baud Rate 1 */
DEFC(   UCB3BR1           , UCB3BR1_)
...
#define UCB3IE_             (0x06BC)  /* USCI B3 Interrupt Enable Register */
DEFC(   UCB3IE            , UCB3IE_)
#define UCB3IFG_            (0x06BD)  /* USCI B3 Interrupt Flags Register */
DEFC(   UCB3IFG           , UCB3IFG_)
